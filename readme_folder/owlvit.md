...
trtexec \
    ...
    --saveEngine=weights/nanoowl/tensorrt/32_text_encoder_fp16_mixed.engine \
    --fp16 \
    ...
    --exportLayerInfo=fp16_mixed_final_build_layer_info.txt > fp16_mixed_final_build_verbose_log.txt 2>&1

trtexec \
    --onnx=weights/nanoowl/onnx/32_image_encoder.onnx \
    --saveEngine=weights/nanoowl/tensorrt/32_image_encoder_fp16_mixed.engine \
    --fp16 \
